...
const PALETTE = {
  '.': null,
  'K': '#181412', // Outline / Very Dark
  'W': '#e8e3d8', // Off-White / Highlight
  'w': '#b3aca0', // Light Grey / Bone
  'g': '#7a756b', // Mid Grey
  'D': '#45413a', // Dark Grey
  ...
  'Y': '#d1b964', // Gold highlight
  'y': '#a38a39', // Gold mid
  'G': '#69551c', // Gold dark

  'R': '#b84d4d', // Red highlight
  'r': '#8c2d2d', // Red mid
  'd': '#541515', // Red dark

  'B': '#5e7a96', // Blue highlight
  'b': '#3d556e', // Blue mid
  'v': '#1f2f40', // Blue dark

  'E': '#6b8256', // Green highlight
  'e': '#445733', // Green mid
  'q': '#233018', // Green dark

  'P': '#8c7096', // Purple highlight
  'p': '#5d4766', // Purple mid
  'u': '#34253b', // Purple dark

  'O': '#967351', // Brown highlight
  'o': '#6b4d32', // Brown mid
  'c': '#3d2816', // Brown dark

  'I': '#81a3a1', // Ice highlight
  'i': '#517371', // Ice mid
  'j': '#2b4241', // Ice dark
};
...
const PORTRAITS = {
  "xiahouyi": [
    ...
    "...............KK${H}${H}${H}${h}${h}${h}${h}${h}${h}${H}${H}KK...............",
    "..............K${H}${H}${H}${H}${h}${h}${h}${h}${h}${h}${h}${h}${H}${H}K..............",
    ".............K${H}${H}${H}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${H}K.............",
    "............K${H}${H}${H}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${D}${h}${h}${H}K............",
    "...........K${H}${H}${H}${h}${h}${h}${h}ssssssss${D}${h}${h}${h}${H}K...........",
    "...........K${H}${H}${h}${h}${h}${h}sSSSSSSSss${D}${h}${h}${h}${H}K...........",
    "..........K${H}${H}${h}${h}${h}${h}sSSsSsSSsSss${D}${h}${h}${h}${H}K..........",
    "..........K${H}${H}${h}${h}${h}sSSssssssssSSs${D}${h}${h}${H}K..........",
    "..........K${H}${h}${h}${h}${h}sSssKsssKssSsZ${D}${h}${h}${H}K..........",
    "..........K${H}${h}${h}${h}${h}sSssKsssKssSsZ${D}${h}${h}${H}K..........",
    "..........K${H}${h}${h}${h}${h}sSssKsssKssSsZ${D}${h}${h}${h}K..........",
    "...........K${h}${h}${h}${h}ZsSsssssssSssZ${h}${h}${h}K...........",
    "...........K${D}${h}${h}${h}${h}ZssSsSsSssSZ${h}${h}${h}${D}K...........",
    "............K${D}${h}${h}${h}ZZsssssssZZ${h}${h}${h}${D}K............",
    ".............K${D}${h}${h}${h}${h}ZZZZZZZ${h}${h}${h}${h}${D}K.............",
    "..............KK${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}${h}KK..............",
    "...............KwwwK${h}${h}${h}${h}${h}${h}${h}KwwwK...............",
    "..............KwwwwwK${h}${h}${h}${h}${h}KwwwwwK..............",
    ".............KwKwWwwwK${h}${h}${h}KwwwWwKwK.............",
    "............KgwwKWWwwwK${h}KwwwWWKwwgK............",
    "............KgwwKWWWwwK${h}KwwWWWKwwgK............",
    "............KKwKKWWWWwK${D}KwwWWWWKKwKK...........",
    ".............KwwKWWWWwwKwwWWWWKwwK............",
    ".............KwwKWWWWwwKwwWWWWKwwK............",
    "............KwwwKWWWWwwwKwwwWWWWKwwwK..........",
    "...........KwWwwKWWWWwwwKwwwWWWWKwwWwK.........",
    "..........KwWWwwKWWWWWwwwwwwWWWWWKwwWWwK........",
    ".........KwWWWwwKKWWWWWWwwwwWWWWWWKKwwWWWwK.......",
    "........KwWWWWwwKwKKWWWWWWWWWWWWKKwKwwWWWWwK......",
    ".......KwWWWWWwwKwwwKKKWWWWWWKKKwwwKwwWWWWWwK.....",
    "......KwWWWWWWwwKwwwwwwKKKKKKwwwwwwKwwWWWWWWwK....",
    ".....KwWWWWWWWwwKwwwwwwwwwwwwwwwwwwKwwWWWWWWWwK...",
    "....KwWWWWWWWWwwKwwwwwwwwwwwwwwwwwwKwwWWWWWWWWwK..",
    "...KwWWWWWWWWWwwKwwwwwwwwwDwwwwwwwwKwwWWWWWWWWWwK.",
    "..KwWWWWWWWWWWwwKwwwwwwwwDDDwwwwwwwKwwWWWWWWWWWWwK",
    ".KwWWWWWWWWWWWwwKwwwwwwwDDDDDwwwwwwKwwWWWWWWWWWWWw",
    "KWWWWWWWWWWWWWwwKwwwwwwDDDDDDDwwwwwKwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKwwwwwDDDDDDDDDwwwwKwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKwwwwDDDDDDDDDDDwwwKwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKwwwDDDDDDDDDDDDDwwwwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKwwDDDDDDDDDDDDDDDwwwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKwDDDDDDDDDDDDDDDDDwwwWWWWWWWWWWWW",
    "KWWWWWWWWWWWWWwwKDDDDDDDDDDDDDDDDDDDwwWWWWWWWWWWWW",
    "................................................"
  ],
  "bingli": [
    "................................................",
...
const SPRITES = {
  "xiahouyi": [
    "............KKKKKKK.............",
    "..........KK${hM}${hM}${hM}${hM}${hM}${hM}${hM}KK...........",
    ".........K${hM}${hM}${hH}${hH}${hH}${hM}${hM}${hM}${hM}${hM}K..........",
    "........K${hM}${hH}${hH}${hH}${hH}${hH}${hH}${hH}${hM}${hM}${hM}${hM}K.........",
    "........K${hH}${hH}${hH}${hM}${hM}${hM}${hH}${hH}${hH}${hM}${hM}${hM}K.........",
    ".......K${hH}${hH}${hH}${hM}sSSs${hM}${hH}${hH}${hH}${hM}${hM}${hM}K.........",
    ".......K${hH}${hH}${hM}sSSSSSs${hM}${hH}${hH}${hH}${hM}${hM}${hM}K........",
    ".......K${hH}${hM}${hM}SsZSsZsZ${hM}${hM}${hH}${hM}${hM}${hM}K........",
    ".......K${hH}${hM}sSSsZSsZSs${hM}${hH}${hM}${hM}K........",
    ".......K${hH}${hM}sSZsZZZsZS${hM}${hH}${hM}${hM}K........",
    ".......K${hH}${hM}sSZZZssZZS${hM}${hH}${hM}${hM}K........",
    "........K${hM}${hM}sSZssssZ${hM}${hM}${hM}${hM}K.........",
    "........K${hM}${hM}${hM}sSZZZZ${hM}${hM}${hM}${hM}${hM}K.........",
    ".........K${hM}${hM}${hM}sss${hM}${hM}${hM}${hM}${hM}K..........",
    ".......KKK${hM}${hM}${hM}${hM}${hM}${hM}${hM}K${hM}${hM}KKK.........",
    "......K${bM}${bM}${bM}KK${hM}${hM}${hM}${hM}K${bM}${bM}${bM}K${bM}${bM}K........",
    ".....K${bM}${bM}${bM}${bM}${bM}${bM}KKKK${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}K.......",
    "....K${bM}${bH}${bH}${bM}${bM}${bM}${bM}${bM}${bD}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}K......",
    "...K${bM}${bH}${bH}${bH}${bH}${bM}${bM}${bM}${bM}${bD}${bD}${bD}${bM}${bM}${bH}${bH}${bM}${bM}${bM}${bM}${bM}${bM}K.....",
    "...K${bH}${bH}${bH}${bH}${bH}${bH}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bM}${bH}${bH}${bH}${bH}${bM}${bM}${bM}${bM}K.....",
    "..K${bM}${bM}${bH}${bH}${bH}${bH}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bD}${bD}${bH}${bH}${bH}${bH}${bM}${bM}${bM}${bM}${bM}K....",
    "..K${bM}${bM}${bH}${bH}${bH}${bH}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bD}${bD}${bH}${bH}${bH}${bH}${bM}${bM}${bM}${bM}${bM}K....",
    "..K${bM}${bM}${bM}${bH}${bH}${bM}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bD}${bD}${bH}${bH}${bH}${bM}${bM}${bM}${bM}${bM}${bM}K....",
    "..K${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}K....",
    "..K${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bD}${bD}${bD}${bD}${bD}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}KK....",
    "...KKK${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bD}${bD}${bD}${bM}${bM}${bM}${bM}${bM}${bM}${bM}KKK......",
    "......KK${bM}${bM}${bM}${bM}${bM}${bM}${bD}${bM}${bM}${bM}${bM}${bM}${bM}KK.........",
    "........KK${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}${bM}KK...........",
    "........K${aM}KK${bM}${bM}${bM}${bM}${bM}KK${aM}K...........",
    ".......K${aM}${aM}${aM}KKKKKKK${aM}${aM}${aM}K..........",
    ".......K${aM}${aM}${aM}${aM}K...K${aM}${aM}${aM}${aM}K..........",
    ".......K${aM}${aM}${aM}K.....K${aM}${aM}${aM}K..........",
    ".......K${aD}${aD}${aM}K.....K${aD}${aD}${aM}K..........",
    ".......K${aD}${aD}${aM}K.....K${aD}${aD}${aM}K..........",
    ".......K${aD}${aD}${aM}K.....K${aD}${aD}${aM}K..........",
    ".......K${aD}${aD}K.......K${aD}${aD}K..........",
    ".......KDK.........KDK..........",
